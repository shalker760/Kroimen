    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 
      ...
      <div className="max-w-4xl text-center relative z-10">
        <h1 className="text-5xl md:text-7xl font-extrabold bg-clip-text 
          ...
          <TypingText text="Райн" />
        </h1>
        
        <p className="text-xl text-white/80 leading-relaxed">
          <TypingText text="это слой, представляющий собой область с наибольшим сходством с привычным нам миром: здесь раскинулись озёра и моря, тянутся бескрайние поля, чередуются болотистые низины и плодородные равнины. Климат данного слоя отличается непостоянством и частыми изменениями погоды. Именно в Райне сосредоточено наибольшее количество населения — сюда стремятся переселиться обитатели иных слоёв, желая обрести размеренное, предсказуемое существование, лишённое крайностей и опасностей." />
        </p>
      </div>
