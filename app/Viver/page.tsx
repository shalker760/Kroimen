    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 
      ...
      <div className="max-w-4xl text-center relative z-10">
        <h1 className="text-5xl md:text-7xl font-extrabold bg-clip-text 
          ...
          <TypingText text="Вивер" />
        </h1>
        
        <p className="text-xl text-white/80 leading-relaxed">
          <TypingText text="это клан, который занимается всесторонним и бескомпромиссным исследованием всех существующих явлений, независимо от их последствий и моральных норм. Из-за своей беззаветной одержимости познанием, Виверы обогатились до такой степени, что их финансовая мощь позволяет им нарушать любые социальные и политические границы, что неизменно вызывает раздражение и неприязнь у других кланов, особенно у Крулов и представителей Диверсии. Виверы предпочитают работать в одиночку, считая всех, кто не разделяет их взглядов, потенциальными угрозами и врагами. Их идеология заключается в абсолютной убежденности в праве на знание любой ценой, что порой приводит к открытому конфликту с окружающими" />
        </p>
      </div>
