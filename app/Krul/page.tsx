    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 
      ...
      <div className="max-w-4xl text-center relative z-10">
        <h1 className="text-5xl md:text-7xl font-extrabold bg-clip-text 
          ...
          <TypingText text="Крул" />
        </h1>
        
        <p className="text-xl text-white/80 leading-relaxed">
          <TypingText text="был основан группой трудяг, стремящихся лишь немного поднять свою известность, но в какой-то момент их амбиции привели их к неожиданным высотам. В результате множества случайных обстоятельств, они не только превзошли собственные ожидания, но и стали важными союзниками Диверсии, сыграв решающую роль в устранении угрозы, исходящей от Вивера, на одном из собраний. В основе Крула — это шахтёры из сурового Дарфа, выковавшие свою судьбу в глубинах земли. Их верность и сила духа делают их надёжными товарищами и союзниками, готовыми встать плечом к плечу с теми, кто разделяет их ценности." />
        </p>
          <p className="text-xl text-white/80 leading-relaxed">
          <TypingText text="Враги:"/>
          <div className="button-shit">
